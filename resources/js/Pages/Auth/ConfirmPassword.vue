...
<template>
    ...
    <ConvidadoLayout>
        <div class="bg-ng-card/95 backdrop-blur-xl shadow-2xl rounded-2xl w-full max-w-md p-8 border border-ng-line">
            <h1 class="text-xl font-semibold text-ng-ink text-center">Confirmar senha</h1>
            <p class="mt-2 text-sm text-ng-ink-muted text-center">
            ...
            <form class="mt-6 space-y-4" @submit.prevent="enviar">
                <div>
                    ...
                    <input
                        ...
                        type="password"
                        class="mt-1 w-full rounded-lg border-ng-line-strong focus:border-[#1fa67e] focus:ring-[#1fa67e]"
                        required
                    >
