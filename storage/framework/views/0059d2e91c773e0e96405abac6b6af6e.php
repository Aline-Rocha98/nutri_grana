<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="dark" data-tema="dark">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

        <title inertia><?php echo e(config('app.name', 'NutriGrana')); ?></title>
        <link rel="icon" href="<?php echo e(asset('images/logo-N.png')); ?>" type="image/png">
...
<?php /**PATH C:\xampp\htdocs\laravel\nutriGrana\resources\views/app.blade.php ENDPATH**/ ?>