...
class OrcamentoServicoResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'liquido_medio_mensal' => $this->formatarMoeda($this->liquido_medio_mensal ?? null),
            'liquido_medio_mensal_numero' => (float) ($this->liquido_medio_mensal ?? 0),
            'receita_prevista_mensal' => $this->formatarMoeda($this->receita_prevista_mensal ?? null),
            'receita_prevista_mensal_numero' => (float) ($this->receita_prevista_mensal ?? 0),
            'saldo_atual_contas' => $this->formatarMoeda($this->saldo_atual_contas ?? null),
            'saldo_atual_contas_numero' => (float) ($this->saldo_atual_contas ?? 0),
            'saldo_conta_selecionada' => $this->formatarMoeda($this->saldo_conta_selecionada ?? null),
            'saldo_conta_selecionada_numero' => (float) ($this->saldo_conta_selecionada ?? 0),
            'limite_disponivel_cartao' => $this->formatarMoeda($this->limite_disponivel_cartao ?? null),
