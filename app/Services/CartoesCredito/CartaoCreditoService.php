...
namespace App\Services\CartoesCredito;

use App\Enum\SimNao;
use App\Models\CartoesCredito\CartaoCredito;
use App\Repositories\CartoesCredito\CartaoCreditoRepository;
...
class CartaoCreditoService
{
    ...
    public function arquivar(CartaoCredito $cartaoCredito, int $idUsuario, bool $arquivada = true): CartaoCredito
    {
        $this->garantirPropriedade($cartaoCredito, $idUsuario);
